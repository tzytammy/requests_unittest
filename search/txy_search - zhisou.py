...
if __name__ == '__main__':
    ...
    url = dataRead.get_url_from_data_file(5)
...
#近30天钻展ROI
driver.find_element_by_xpath("//div[ @class ='store-con'] /div[4]/div[16]/div[1]/p[1]/label[6]/input[1] ").click()


#描述一下您的直通车推广现状
driver.find_element_by_xpath("//div[ @class ='store-con'] /div[4]/div[17]/div[1]/textarea[1]").send_keys("搜索情况现状")
#描述一下您的钻展推广现状
driver.find_element_by_xpath("//div[ @class ='store-con'] /div[4]/div[18]/div[1]/textarea[1]").send_keys("直通车推广现状")
...
# 第二页报名学员信息
#参加人姓名
driver.find_element_by_xpath("//div[ @class ='store-con']/div[5]/div[2]/div[1]/div[1]/input[1]").send_keys("搜索情况现状")
