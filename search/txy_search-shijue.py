...
if __name__ == '__main__':
    ...
    url = dataRead.get_url_from_data_file(8)
...
#近30天爆款转化率
driver.find_element_by_xpath("//*[@id='ng-app']/body/div[1]/div[5]/div/div/div[2]/div[1]/div/div/div[4]/div[14]/div/input").send_keys("10")
#除了这个主题还有哪些是您目前急需了解的？
driver.find_element_by_xpath("//*[@id='ng-app']/body/div[1]/div[5]/div/div/div[2]/div[1]/div/div/div[4]/div[15]/div/p/label[1]/input").click()
#描述一下您的视觉现状
driver.find_element_by_xpath("//*[@id='ng-app']/body/div[1]/div[5]/div/div/div[2]/div[1]/div/div/div[4]/div[16]/div[2]/textarea").send_keys("10")
#点击下一步
